...
- GitHub Actions: **내일 볼 종목**(15:55) · **오늘 매수 후보**(10:25) · 수동 재평가/테스트
- `trading_value_ratio_20d` (20일 평균 거래대금 대비) · 임시 관찰 후보 JSON

## 3. 현재 유지하는 것

- **오늘 매수 후보 알림** (KST 10:25, 관심종목+임시 관찰)
- **내일 볼 종목 알림** (KST 15:55, 신규 관찰 후보만)
