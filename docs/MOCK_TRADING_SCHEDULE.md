...
|----------|------|----------------|--------------|
| 1 | NXT 가능 | 당일 **16:00~18:00** | `NXT_AFTER_MARKET` |
...
- `POST /api/mock-trading/scheduled-judgment`
- `POST /api/mock-trading/execute-pending`
- `POST /api/mock-trading/realtime-watch`
- `POST /api/mock-trading/intraday-judgment`
